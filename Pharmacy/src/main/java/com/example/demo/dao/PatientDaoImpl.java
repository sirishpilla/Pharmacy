...
public class PatientDaoImpl implements PatientDao {
	...
	public void updatePatient(pri_phy_patient patient) {
		// TODO Auto-generated method stub
		String query = "UPDATE pri_phy_patient SET name=?, birth_date=?, address=?,phy_ssn=? WHERE ssn=?";
		jdbcTemplate.update(query, patient.getName(), patient.getBirth_date(), patient.getAddress(),
				patient.getPhy_ssn(), patient.getSsn());
